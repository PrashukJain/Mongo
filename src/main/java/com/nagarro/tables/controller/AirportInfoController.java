...
public void addInfo(@RequestBody AirportInfo objectData){
...
@PutMapping("/edit/{id}")
public void editAirportInfo(@PathVariable("id") String id,@RequestBody AirportInfo infoObject) {
	System.out.println("Airport edit");
	try {
...
return airportInfoService.fetchByCountry(country);
}
